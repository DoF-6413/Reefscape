...
public class PathPlanner {
  ...
  public PathPlanner(Drive drive, Vision vision) {
    ...
    // Tunable PathPlanner PID values
    SmartDashboard.putNumber("PIDFF/PathPlanner/X-kP", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/X-kI", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/X-kD", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/Y-kP", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/Y-kI", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/Y-kD", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/Theta-kP", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/Theta-kI", 0);
    SmartDashboard.putNumber("PIDFF/PathPlanner/Theta-kD", 0);
  }
