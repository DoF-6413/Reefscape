...
public class AlgaeCommands {
    ...
    public static Command mechanisms2Net(
        Periscope periscope,
        AlgaePivot AEEPivot) { 
            ...
            periscope,
            AEEPivot,
            PeriscopeConstants.NET_HEIGHT_M,
            AlgaePivotConstants.NET_POSITION_RAD);
    }
    public static Command mechanisms2PickupL2(
        Periscope periscope,
        AlgaePivot AEEPivot) { 
    ...
    public static Command mechanisms2PickupL3(
        Periscope periscope,
        AlgaePivot AEEPivot) { 
    ...
    public static Command mechanisms2Processor(
        Periscope periscope,
        AlgaePivot AEEPivot) { 
